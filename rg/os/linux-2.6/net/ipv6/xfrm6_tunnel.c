...
static int __init xfrm6_tunnel_init(void)
{
	...
	if (xfrm6_tunnel_register(&xfrm46_tunnel_handler, AF_INET)) {
		...
		X6TPRINTK1(KERN_ERR
			   "xfrm6_tunnel init(): can't add xfrm6 AF_INET\n");
...
static void __exit xfrm6_tunnel_fini(void)
{
	...
	if (xfrm6_tunnel_deregister(&xfrm46_tunnel_handler, AF_INET) < 0){	
		X6TPRINTK1(KERN_ERR 
			   "xfrm6_tunnel close: can't remove protocol AF_INET\n");
	}
	if (xfrm6_tunnel_deregister(&xfrm6_tunnel_handler, AF_INET6) < 0){	
		X6TPRINTK1(KERN_ERR 
			   "xfrm6_tunnel close: can't remove protocol AF_INET6\n");
	}
