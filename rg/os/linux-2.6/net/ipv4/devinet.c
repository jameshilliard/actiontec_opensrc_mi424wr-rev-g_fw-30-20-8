 ...
 *
 *	Version: $Id: devinet.c,v 1.1.1.1.56.1 2012/02/10 06:30:08 simba Exp $
 *
			 ...
			 void *ptr)
{
	...
	if (!in_dev) {
#ifdef CONFIG_IOT_DSLITE
		/* when dev is dslite, allocate ip_ptr for ipv4 */
		if (event == NETDEV_REGISTER && (dev == &loopback_dev || !strcmp(dev->name, "dslite") )) {
#else
