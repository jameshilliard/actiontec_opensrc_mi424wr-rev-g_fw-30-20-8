 ...
 *
 *		$Id: snmp.h,v 1.1.1.1.54.1 2011/04/20 00:38:40 athill Exp $
 *
 */
...
#if defined(CONFIG_ARCH_FEROCEON) && defined(CONFIG_MV_LINUX_COUNTERS_DISABLE)
...
#endif /* CONFIG_ARCH_FEROCEON && CONFIG_MV_LINUX_COUNTERS_DISABLE */ 
